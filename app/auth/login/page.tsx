...
export default function LoginPage() {
  ...
  // Wrapper to handle the server action
  ...
  return (
    // 🟢 MOBILE: 'overflow-hidden' stops accidental scrolling
    <div className="relative flex min-h-screen w-full items-center justify-center px-4 py-12 overflow-hidden bg-slate-950">
      ...
      <Image
        ...
        priority // ⚡️ Loads immediately (LCP)
        sizes="100vw" // ⚡️ Downloads the correct size for the device
      />
        ...
        <form action={handleFormAction}>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              {/* 🟢 MOBILE: 'text-base' prevents iOS zoom. 'md:text-sm' reverts it on desktop. */}
              <Input
                id="email"
                name="email"
                type="email"
            ...
            <div className="space-y-2">
              {/* 🟢 FIXED: 'htmlFor' was broken in previous code */}
